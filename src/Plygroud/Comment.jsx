    ...
    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
      <div className="p-6 mb-6 bg-gray-50 dark:bg-gray-900">
                ...
                <li>
                  <a href="#">
                    <svg
                      ...
                      height={16}
                      fill="currentColor"
                      className="w-4 mr-1 text-emerald-500 dark:text-emerald-400 bi bi-star-half"
                      viewBox="0 0 16 16"
                    >
          ...
          <div className="flex items-center mb-3">
            <div className="flex mr-2 text-xs text-black dark:text-gray-400">
              ...
              <svg
                ...
                height={16}
                fill="currentColor"
                className="w-3 h-3 text-emerald-500 dark:text-emerald-400 bi bi-star-fill"
                viewBox="0 0 16 16"
              >
                <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"></path>
              </svg>
        ...
        <div className="items-center ">
          <a
            href="#"
            className="px-4 py-2 text-xs text-gray-100 bg-emerald-500 hover:bg-emerald-600 "
          >
            View all reviews
          </a>
        </div>
      ...
      <div className="p-6 mb-6 bg-white dark:bg-gray-900">
        ...
        <form action="" className="">
          ...
          <div className="">
            <button className="px-4 py-2 text-xs font-medium text-gray-100 bg-emerald-500 hover:bg-emerald-700 dark:bg-emerald-500 dark:hover:bg-emerald-700">
              Submit comment
            </button>
          </div>
        </form>
