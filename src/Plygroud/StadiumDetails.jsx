...
const StadiumDetails = () => {
  ...
  const [showBookingForm, setShowBookingForm] = useState(false); // State to control the visibility of the booking form
  const { id } = useParams();
  ...
  const handleBookNowClick = () => {
    setShowBookingForm(true); // Set showBookingForm to true when Book Now is clicked
  };

  return (
    <div>
      {showBookingForm && <BookingForm />} {/* Render BookingForm when showBookingForm is true */}
          ...
          <div className="flex flex-wrap -mx-4">
            ...
            <div className="w-full px-4 md:w-1/2 ">
              <div className="lg:pl-20">
                ...
                {/* <div className="mb-8">
                  <h2 className="w-40 pb-3 mb-4 text-3xl font-bold border-b border-emerald-300 dark:text-gray-400 dark:border-gray-600">
                    Attachment
                  </h2>
